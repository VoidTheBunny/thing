...
const givechar_command = @import("./commands/givechar.zig");
const givelight_command = @import("./commands/givelight.zig");
...
const commandList = [_]Command{
    ...
    .{ .name = "givechar", .action = "", .func = givechar_command.onGiveChar },
    .{ .name = "givelight", .action = "", .func = givelight_command.onGiveLight },
};
