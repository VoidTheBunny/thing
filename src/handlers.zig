...
pub const HandlerList = [_]struct { CmdID, Action }{
    ...
    .{ CmdID.CmdDressAvatarCsReq, avatar.onDressAvatar },
    .{ CmdID.CmdTakeOffEquipmentCsReq, avatar.onTakeOffEquipment },
    .{ CmdID.CmdDressRelicAvatarCsReq, avatar.onDressRelicAvatar },
    .{ CmdID.CmdTakeOffRelicCsReq, avatar.onTakeOffRelic },
    //lineup
